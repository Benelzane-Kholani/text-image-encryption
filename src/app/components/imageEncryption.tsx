    ...
    return(
     <div className={`encryptionContainer mt-4 ${showDisplay()}`}>
      ...
      <div className={`flex mt-6 gap-2`}>
        <div className='flex w-1/3 border border-indigo-500 rounded h-15 p-2'>
        <input type="file"
        className="file:mr-4 file:rounded-full file:border-0
         file:px-4 file:py-2 file:text-sm file:font-semibold file:text-gray-400
         dark:file:bg-indigo-500 dark:file:text-violet-100
         dark:hover:file:bg-indigo-400 self-center"/>
     </div>

     <div className='w-1/3 border rounded border-indigo-500 text-gray-400 p-2'>
